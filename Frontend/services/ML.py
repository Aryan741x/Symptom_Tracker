...
example_symptoms = ['cough']
# Encode the example symptoms using one-hot encoding
example_symptoms_encoded = [1 if symptom in example_symptoms else 0 for symptom in l1]
...
print("Predicted disease:", disease[predicted_disease[0]])
